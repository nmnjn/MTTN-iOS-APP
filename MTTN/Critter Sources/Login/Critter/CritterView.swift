...
final class CritterView: UIView {
    ...
    @objc func startHeadRotation(startAt fractionComplete: Float) {
    ...
    @objc func updateHeadRotation(to fractionComplete: Float) {
        activeEndAnimator?.fractionComplete = CGFloat(fractionComplete)
    }

    @objc func stopHeadRotation() {
